            ...
            <div className="max-w-[1152px] flex flex-col gap-8">
              <div className="fade-in flex justify-center">
                <div className="fade-in flex flex-col gap-4 mx-auto max-w-[660px]">
                  <h2 className="text-[30px] md:text-[46px] lg:text-[48px] text-center font-semibold leading-[40px] lg:leading-[58px]">
                    Get An Online Doctor's <br /> Note In 3 Easy Steps
                  </h2>
                  <p className="text-zinc-600 text-[15px] md:text-[18px] leading-[23px]">
              ...
              <div className="fade-in flex justify-between flex-col md:flex-row gap-4">
                {cardData.map((c) => (
                  <div
                    key={c.id}
                    className="flex-1 flex flex-col items-center gap-4 px-6 pt-6 pb-12 h-max rounded-xl bg-blue-100"
                  >
                    ...
                    <h4 className="text-[23px] md:text-[25px] lg:text-[24px] leading-[36px] text-center font-semibold tracking-wide">
                      {c.title}
                    </h4>
                    <p className="text-[14px] md:text-[18px] lg:text-[14px] leading-[18px] text-zinc-600 tracking-wider">
                      {c.desc}
                    </p>
                  </div>
                ))}
              ...
              <div className="fade-in my-6 bg-[#B9EEDF] p-[30px] rounded-xl">
                <div className="flex justify-center items-center flex-col md:flex-row gap-6 max-w-[742px] mx-auto">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="200"
                    height="179"
                  ...
                  <div className="flex flex-col gap-3">
                    <h4 className="text-[24px] md:text-[32px] leading-[42px] text-center md:text-left font-semibold">
                      Money Back Guarantee!
                    </h4>
                    <p className="text-[14px] md:text-[18px] leading-[23px] text-center md:text-left font-medium">
                      We will refund 100% of your payment, in case you're not
              ...
              <div className="fade-in flex flex-col justify-center">
                <div className="max-w-[530px] mx-auto flex flex-col gap-4">
                  <div className="flex flex-col items-center">
                    <h2 className="text-center text-[32px] md:text-[46px] lg:text-[48px] leading-[49px] md:leading-[58px] font-semibold">
                      Get Peace of Mind With{' '}
                      <span className="font-semibold text-[#2323FE]">
                        My Doctors Note
                      </span>
                    </h2>
                    <svg
                  ...
                  <p className="text-[15px] md:text-[18px] text-zinc-600 leading-[23px] tracking-wide">
              ...
              <div className="fade-in flex flex-col md:flex-row gap-4 mb-6">
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  <div className="h-max flex flex-col gap-4 px-5 py-6 bg-blue-100 border border-white rounded-xl">
                    ...
                    <div className="flex  items-center py-2 gap-8">
                      ...
                      />
                      <p className="w-1/2 text-[14px] md:text-[16px] lg:text-[22px] text-emerald-500 font-bold tracking-wide">
                        We're ready to help!
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  <div className="h-max flex flex-col gap-4 px-5 py-6 bg-blue-100 border border-white rounded-xl">
                    <h5 className="text-[23px] md:text-[25px] lg:text-[24px] text-center font-semibold">
                      The Best Price In The Market
                    </h5>
                    <p className="text-center line-through pt-2 text-[20px] md:text-[32px] lg:text-[30px] font-semibold text-zinc-600">
                      $42.99
                    </p>
                    <p className="text-center text-[56px] md:text-[47px] lg:text-[70px] font-semibold">
                      $29.99
                    </p>
                    <p className="text-[18px] md:text-[25px] lg:text-[24px] text-center text-emerald-500 font-bold tracking-wide">
